...
export default function ChatMessage(chatMessage: Message) {
  ...
  return (
    <div className={`flex ${chatMessage.role === "user" ? "justify-end" : "justify-start"} items-start gap-4 pr-5 pt-5`}>
      <div className={`group flex ${chatMessage.role === "user" ? "flex-row-reverse" : "flex-row"} gap-2`}>
